    ...
    public static class MatrixIncDbInitializer
    {
        public static void Initialize(MatrixIncDbContext context)
        {
            ...
            var customers = new Customer[]
            {
                ...
                new Customer { Name = "Niobe", StreetName = "Spruce St", HouseNumber = "707", PostalCode = "10010", CityName = "Matrix Hills", Country = "Matrixland", Active = true, JoinDate = DateTime.Parse("2020-10-07") },
                new Customer { Name = "Link", StreetName = "Fir St", HouseNumber = "808", PostalCode = "10011", CityName = "Matrix Hills", Country = "Matrixland", Active = true, JoinDate = DateTime.Parse("2020-11-18") },
